// Cloudflare Pages Function — proxiet Finnhub quote-aanvragen
// API-sleutel staat als omgevingsvariabele FINNHUB_KEY op Cloudflare
// Bezoekers zien de sleutel nooit
...
export async function onRequest(context) {
  ...
  try {
    ...
    return json(data, 200, 60); // 60s cache
  } catch (e) {
